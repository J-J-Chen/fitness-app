...
public class NavigationDrawerFragment extends Fragment {
    ...
    private boolean mUserLearnedDraw;
    private boolean mFromSavedInstancesState;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mUserLearnedDraw = Boolean.valueOf(AppSharedPreferences.hasUserLearned(getActivity(),
                AppConstant.KEY_USER_LEARNED_DRAWER, AppConstant.FALSE));
        if (savedInstanceState != null) {
            mFromSavedInstancesState = true;
        }
    }
    ...
    public void setUp(int fragmentId, DrawerLayout drawerLayout, final Toolbar toolbar) {
        ...
        if (!mUserLearnedDraw && !mFromSavedInstancesState) {
